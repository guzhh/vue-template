...
// };
//
// function genScssMultipleScopeVars() {
// 	const result = [];
// 	for (let i = 0; i < APP_PRESET_COLOR_LIST.length; i++) {
// 		result.push({
// 			scopeName: `theme-${i}`,
// 			varsContent: `$primary-color: ${APP_PRESET_COLOR_LIST[i]} !default;$vxe-primary-color: $primary-color;`
// 		});
// 	}
// 	result.push(THEME_DARK);
// 	return result;
// }
//
// export function configVxeTableThemePlugin() {
